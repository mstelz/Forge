...
import type { Program, ProgramDay } from "../../../../shared";
...
export type BuilderAction =
  ...
  | { type: "SET_DAY"; weekIndex: number; dayIndex: number; routineId: string | null; isRestDay: boolean; notes?: string | null }
...
export function builderReducer(state: BuilderState, action: BuilderAction): BuilderState {
  switch (action.type) {
    ...
    case "SET_DAY": {
      const { weekIndex, dayIndex, routineId, isRestDay, notes } = action;
