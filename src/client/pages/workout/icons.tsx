// Pure presentational SVG icons used by the active-workout page.
// Extracted from active.tsx (issue 01) — no state, no props beyond optional className.
